                    ...
                    <div class="card shadow h-100">
                        <div class="card-body">
                            <h5 class="card-title text-center">
                                <a class="text-decoration-none" href="/kompanija/${company.id}/${company.slug}">
                                    ${ company.name }
                                </a>
                            </h5>
                            <div class="d-flex flex-wrap justify-content-center mb-3 gap-2">
                                ${Object.values(company.category).map(function(category) {
                        ...
                        <div class="card-footer">
                            <div class="d-flex justify-content-around">
                                ...
                                <a href="/kompanija/${company.id}/${company.slug}" class="text-decoration-none">
                                    <i class="bi bi-clipboard-check-fill"></i>
                                    Br. recenzija
                                </a> 
                                <div>
                                    <a href="${ company.website_url }"><i class="bi bi-link-45deg"></i></a>
                                </div> 
                            </div>
                        </div>
                    </div>
